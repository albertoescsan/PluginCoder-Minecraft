...
public class InstructionsGUI {
    ...
    public void updateGUI(){
        ...
        ItemStack variable=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("FILLED_MAP"));
        for(int i=10;i<17;i++){
        ...
        ItemStack execute=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("FILLED_MAP"));
        ...
        ItemStack conditional=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
        meta=conditional.getItemMeta();
        meta.setDisplayName(ChatColor.WHITE+conditionalTitle);
        conditional.setItemMeta(meta);
        ItemStack loopsItem=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
        meta=loopsItem.getItemMeta();
        meta.setDisplayName(ChatColor.WHITE+loopsTitle);
        loopsItem.setItemMeta(meta);
        ItemStack delayFunction=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
        ...
        ItemStack repeatFunction=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
        ...
        ItemStack returnItem=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("FILLED_MAP"));
        ...
        ItemStack forLoop=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
        ...
        ItemStack whileLoop=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
        ...
        ItemStack ifConditional=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
        ...
        ItemStack elseifConditional=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
        ...
        ItemStack elseConditional=new ItemStack(plugin.getCodeUtils().getVersionedMaterial("WRITABLE_BOOK"));
