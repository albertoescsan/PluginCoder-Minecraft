...
public class EventsGUI {
    ...
    private void generateEventItems(){
        ItemStack playerJoin=plugin.getVersionNumber()<13?
        ...
        ItemStack playerLeave=plugin.getVersionNumber()<13?
        ...
        ItemStack blockPlace=new ItemStack(plugin.getCodeUtils().getVersionedMaterial(Material.GRASS_BLOCK));
        ...
        ItemStack playerDie=new ItemStack(plugin.getCodeUtils().getVersionedMaterial(Material.SKELETON_SKULL),1,(short)3);
    ...
    public void updateGUI() {
        ...
        ItemStack add=new ItemStack(plugin.getCodeUtils().getVersionedMaterial(Material.ENDER_EYE));
        ...
        if(plugin.getSelectedPlugin().getListener().isEmpty()){
            createPage(0,add,delete,eventsTitle);return;
        }
        int i=10;
        int invIndex=0;
        for(String event:plugin.getSelectedPlugin().getListener()){
    ...
    public void updateLastEventEdited() {
        ...
        String function=plugin.getSelectedPlugin().getListener().get(eventEditedIndex);
        ItemStack newItem=plugin.getFunctionGUI().getInstructionItem(function);
